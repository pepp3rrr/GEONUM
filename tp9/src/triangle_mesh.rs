...
impl TriangleMesh {
    ...
    fn get_adjacent_faces(&self, edge: &(usize, usize)) -> Vec<(usize, usize, usize)> {
    ...
    fn get_neighbour_faces(&self, edge: &(usize, usize)) -> Vec<(usize, usize, usize)> {
    ...
    fn get_neighbour_vertices(&self, edge: &(usize, usize)) -> Vec<Point<3>> {
